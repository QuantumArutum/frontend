    ...
    <div className={`min-h-screen relative overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 1 }}>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="w-96 h-96 border border-purple-500/20 rounded-full animate-ping" style={{ animationDuration: '4s' }}></div>
          <div className="absolute inset-0 w-96 h-96 border border-cyan-500/20 rounded-full animate-ping" style={{ animationDuration: '6s', animationDelay: '2s' }}></div>
        </div>
      </div>
    </div>
  );
