export const es = {
  translation: {
    ...
    hero: {
      ...
      stats: {
        realtime: 'Rendimiento en tiempo real',
        tps: { value: '100,000+', label: 'Transacciones por segundo', unit: ' TPS' },
        score: { value: '99.9', label: 'Puntuación de seguridad', unit: '%' },
      ...
      modal: {
        ...
        description: 'Añadir red Quantaureum a tu billetera MetaMask',
        network: 'Red',
        chainId: 'ID de Cadena',
        symbol: 'Símbolo',
        rpc: 'RPC',
        connected: 'Conectado',
        connect_failed: 'Conexión fallida, por favor intente de nuevo',
    ...
    team: {
      ...
      description: 'Compuesto por los mejores criptógrafos y expertos en blockchain',
      members: {
    ...
    features: {
      ...
      description: 'Soluciones blockchain completas',
      badges: {
    ...
    wallet: {
      title: 'Billetera Cuántica',
      description: 'Billetera digital segura basada en tecnología de cifrado cuántico',
    ...
    specs: {
      ...
      data: {
        crypto: {
          dilithium: 'Algoritmo de firma digital estándar NIST',
          kyber: 'Mecanismo de encapsulación de claves estándar NIST',
          sphincs: 'Firma basada en hash estándar NIST',
          sphincs_value: 'Sin estado',
          prng_label: 'Generación Aleatoria',
          prng_value: 'QRNG',
          prng: 'Generador de números aleatorios cuánticos',
          key_length_label: 'Longitud de Clave',
        ...
        performance: {
          ...
          block_time: 'Intervalo de bloque promedio',
          key_gen_label: 'Generación de Clave',
          key_gen_value: '0.5ms',
          key_gen: 'Tiempo de generación de par de claves',
          verify_label: 'Verificación de Firma',
          verify_value: '0.3ms',
          verify: 'Tiempo de verificación de firma única',
        ...
        security: {
          ...
          vulnerabilities: 'Auditoría de seguridad completa',
          coverage_label: 'Cobertura de Código',
          coverage_value: '95%',
          coverage: 'Cobertura de código de prueba',
          penetration_label: 'Prueba de Penetración',
          penetration_value: 'Pasada',
          penetration: 'Prueba de penetración de terceros',
          quantum_resistance_label: 'Resistencia Cuántica',
          quantum_resistance_value: 'Nivel NIST 3',
          quantum_resistance: 'Nivel de seguridad post-cuántica',
          side_channel_label: 'Protección de Canal Lateral',
        ...
        compatibility: {
          ...
          evm_value: 'Totalmente Compatible',
          evm: 'Compatible con Máquina Virtual Ethereum',
          protocols_label: 'Soporte de Protocolo',
          protocols_value: 'JSON-RPC',
          protocols: 'Protocolo RPC Estándar',
          hardware_label: 'Billetera de Hardware',
          hardware_value: 'Ledger/Trezor',
          hardware: 'Soporte de principales billeteras de hardware',
          api_label: 'Versión de API',
          api_value: 'v2.0',
          api: 'API REST y WebSocket',
          languages_label: 'Lenguajes de Desarrollo',
          languages_value: '10+',
      ...
      status: {
        ...
        network_desc: 'Todos los nodos en línea',
        nodes_label: 'Nodos Activos',
        nodes_value: '156',
        nodes_desc: 'Distribuidos globalmente',
        tps_label: 'TPS Actual',
        tps_value: '1,250',
    ...
    demo: {
      ...
      steps: {
        ...
        quantum_compile: 'Compilación Cuántica',
        deploy_chain: 'Desplegar en Cadena',
        execute_call: 'Ejecutar Llamada',
        device_detect: 'Detección de Dispositivo',
        key_generation: 'Generación de Clave',
        biometric_auth: 'Auth Biométrica',
        quantum_sign: 'Firma Cuántica',
        select_source: 'Seleccionar Cadena Origen',
        create_proof: 'Crear Prueba',
        lock_assets: 'Bloquear Activos',
        release_target: 'Liberar en Destino',
      ...
      performance: {
        ...
        execution_speed: 'Velocidad de Ejecución',
      ...
      security: {
        ...
        quantum_level: 'Nivel Cuántico',
        quantum_level_value: 'Nivel NIST 3',
      ...
      compatibility: {
        ...
        supported_devices_value: 'Todas las Plataformas',
    ...
    ecosystem: {
      ...
      description: 'Explore el rico ecosistema de aplicaciones descentralizadas de Quantaureum',
      status: {
        online: 'En Línea',
    ...
    dashboard: {
      ...
      working_on_it: 'El Panel de Usuario está en desarrollo...',
      login_success: '¡Inicio de sesión exitoso! Bienvenido de nuevo',
      login_failed: 'Inicio de sesión fallido, por favor intente de nuevo',
      wallet_balance: 'Saldo de Billetera',
      recent_transactions: 'Transacciones Recientes',
      send_qau: 'Enviar QAU',
      receive_qau: 'Recibir QAU',
      app_usage: 'Uso de App',
      market: 'Mercado',
      defi: 'Protocolo DeFi',
      active: 'Activo',
      staking: 'Staking'
    ...
    gold: {
      ...
      description: 'Quantaureum (QAU) está estrictamente vinculado al oro físico.',
    ...
    explorer: {
      ...
      subtitle: 'Explore bloques, transacciones y direcciones en la red Quantaureum',
      search_placeholder: 'Buscar por Bloque, Hash de Transacción o Dirección',
      stats: {
    ...
    about: {
      ...
      contact: {
        title: 'Contáctenos',
        subtitle: 'Si tiene alguna pregunta o intención de cooperación, no dude en contactarnos',
    ...
    defi_page: {
      ...
      subtitle: 'Plataforma de Servicios Financieros Descentralizados',
      ...
      modal: {
        add_liquidity: 'Añadir Liquidez',
        lending_action: 'Acción de Préstamo',
        stake_tokens: 'Apostar Tokens',
        stake_lp: 'Apostar LP',
        amount: 'Cantidad',
        cancel: 'Cancelar',
    ...
    auth: {
      login: {
        ...
        subtitle: 'Inicia sesión en tu cuenta Quantaureum',
        ...
        security_note: 'Tus datos están protegidos con encriptación de nivel cuántico',
      ...
      register: {
        title: 'Crear Cuenta',
        subtitle: 'Únete al ecosistema Quantaureum',
        step_basic_info: 'Información Básica',
        step_password: 'Configurar Contraseña',
        step_security: 'Configuración de Seguridad',
        step_terms: 'Términos y Acuerdos',
        first_name: 'Nombre',
        ...
        country_placeholder: 'Selecciona',
        password_label: 'Contraseña',
        password_placeholder: 'Ingresa tu contraseña',
        ...
        security_answer_placeholder: 'Ingresa tu respuesta',
        enable_2fa: 'Habilitar Autenticación de Dos Factores (Recomendado)',
        enable_2fa_desc: 'Añade seguridad extra a tu cuenta',
        ...
        register_failed: 'Error de registro, intenta más tarde',
        network_error: 'Error de red, intenta más tarde',
        validation: {
          first_name_required: 'Por favor ingresa tu nombre',
          last_name_required: 'Por favor ingresa tu apellido',
          email_required: 'Por favor ingresa tu correo',
          email_invalid: 'Formato de correo inválido',
          phone_required: 'Por favor ingresa tu teléfono',
          dob_required: 'Por favor selecciona tu fecha de nacimiento',
          country_required: 'Por favor selecciona tu país/región',
          password_required: 'Por favor ingresa tu contraseña',
          password_min_length: 'La contraseña debe tener al menos 8 caracteres',
          password_complexity: 'La contraseña debe contener mayúsculas, minúsculas y números',
    ...
    contact: {
      ...
      form: {
        ...
        company_placeholder: 'Nombre de empresa (opcional)',
        subject_label: 'Asunto *',
        subject_placeholder: 'Asunto del mensaje',
        message_label: 'Mensaje *',
        message_placeholder: 'Describe tu pregunta o solicitud en detalle...',
    ...
    settings: {
      ...
      subtitle: 'Administra la seguridad de tu cuenta e información personal',
      tabs: {
      ...
      kyc: {
        ...
        levels: {
          title: 'Descripción de Niveles de Verificación',
          basic: {
        ...
        modal: {
          ...
          document_number_placeholder: 'Ingresa número de documento',
          dob: 'Fecha de Nacimiento',
          nationality: 'Nacionalidad',
          upload_title: 'Subir Fotos del Documento',
    ...
    staking: {
      ...
      pool: {
        ...
        days: 'Días',
        amount_placeholder: 'Ingresa cantidad',
        max: 'MÁX',
        confirm_stake: 'Confirmar Stake',
        confirm_unstake: 'Confirmar Unstake',
        no_lock: 'Sin Período de Bloqueo',
        day_lock: ' Días de Bloqueo',
        early_penalty: 'Penalización por Retiro Anticipado',
        ...
        unstake_amount: 'Cantidad de Unstake',
        available: 'Disponible',
        estimated_rewards: 'Recompensas Anuales Estimadas',
        processing: 'Procesando...',
        cancel: 'Cancelar',
        claim: 'Reclamar',
        rewards: 'Recompensas',
      ...
      errors: {
        ...
        invalid_amount: 'Por favor ingresa una cantidad válida',
    ...
    explorer_pages: {
      address: {
        loading: 'Cargando información de dirección...',
        ...
        more_stats: 'Más estadísticas próximamente...',
      ...
      validators: {
        title: 'Validadores',
        subtitle: 'Validadores de Red y Estado de Staking',
        showing_top: 'Mostrando principales validadores',
        loading: 'Cargando datos de validadores...',
        index: 'Índice',
        validator_key: 'Clave de Validador',
        stake: 'Stake',
        status: 'Estado',
        activity: 'Actividad',
        proposer: 'Proponente',
      ...
      quantum_verify: {
        ...
        subtitle: 'Verificar firmas de transacción para resistencia cuántica',
    ...
    community_page: {
      ...
      categories: {
        ...
        general_desc: 'Discusiones y anuncios de la comunidad',
        technical: 'Técnico',
        technical_desc: 'Temas de desarrollo y técnicos',
        defi: 'DeFi & Trading',
    ...
    governance_page: {
      ...
      create_form: {
        ...
        proposal_title_placeholder: 'Ingresa el título de la propuesta...',
        category: 'Categoría de la Propuesta',
        categories: {
          tech: 'Actualización Técnica',
        ...
        tags: 'Etiquetas de la Propuesta',
        tags_placeholder: 'Ingresa etiquetas separadas por comas...',
        requirements: {
          title: 'Requisitos de la Propuesta',
    ...
    create_post_page: {
      ...
      subtitle: 'Comparte tus ideas con la comunidad',
      verifying_login: 'Verificando estado de inicio de sesión...',
      form: {
        category: 'Categoría',
        categories: {
          general: 'Discusión General',
    ...
    governance_component: {
      title: 'Gobernanza',
      subtitle: 'Participa en la toma de decisiones de la comunidad',
    ...
    // Página de Staking
    staking_page: {
      title: 'Staking Cuántico',
      subtitle: 'Gana ingresos pasivos asegurando la red. Alto APY, seguro y flexible.',
      active_pools: 'Pools Activos',
      my_stakes: 'Mis Stakes',
      duration: 'Duración',
      days: 'Días',
      min_stake: 'Stake Mínimo',
      total_staked: 'Total en Stake',
      stake_now: 'Hacer Stake Ahora',
      stake: 'Stake',
      unlocks: 'Desbloqueo',
      active: 'Activo',
      confirm_stake: 'Confirmar Stake',
      ...
      mock: 'Simulado',
      amount_placeholder: 'Cantidad a stakear',
      lock_period: 'Período de bloqueo',
    ...
    settings_page: {
      ...
      notifications: {
        ...
        push_desc: 'Recibir notificaciones de transacciones y sistema',
        sound: 'Alertas de Sonido',
        sound_desc: 'Reproducir sonidos de notificación'
      },
      language: {
        title: 'Idioma',
        interface: 'Idioma de Interfaz',
        interface_desc: 'Selecciona tu idioma preferido'
      },
      security: {
        title: 'Seguridad',
        two_factor: 'Autenticación de Dos Factores',
        two_factor_desc: 'Mejorar la seguridad de la cuenta',
        quantum_encryption: 'Cifrado Cuántico',
        quantum_encryption_desc: 'Protegido con criptografía post-cuántica',
        enabled: 'Habilitado',
    ...
    faq_page: {
      ...
      subtitle: 'Encuentra las respuestas que necesitas y aprende más sobre Quantaureum',
      search_placeholder: 'Buscar preguntas...',
      no_results: 'No se encontraron preguntas relacionadas',
      more_questions: '¿Más preguntas?',
      support_team: 'Nuestro equipo de soporte está listo para ayudarte',
    ...
    lottery_page: {
      title: 'Lotería Cuántica',
      subtitle: 'Super Loto basado en números aleatorios cuánticos',
      tabs: {
        buy: 'Comprar Boletos',
        results: 'Resultados',
        mybets: 'Mis Apuestas',
      ...
      back_zone: 'Zona Trasera',
      select_from: 'Selecciona {{count}} de 1-{{max}}',
      bet_info: 'Información de Apuesta',
      quantum_secure: 'Seguro Cuántico',
      bets: 'Apuestas',
      single_bet: 'Apuesta Simple',
      total_amount: 'Monto Total',
      selected_numbers: 'Números Seleccionados',
      place_bet: 'Realizar Apuesta',
      select_complete: 'Por favor selecciona una combinación completa',
      prize_levels: 'Niveles de Premio',
      probability: 'Probabilidad',
      floating_prize: 'Premio Flotante',
      history_results: 'Resultados Históricos',
      draw_number: 'Número de Sorteo',
      winning_numbers: 'Números Ganadores',
      quantum_verified: 'Verificado Cuántico',
      sales: 'Ventas',
      total_bets: 'Total de Apuestas',
      prize_pool: 'Pozo de Premios',
      no_bets: 'Sin historial de apuestas',
      connect_wallet_view: 'Conecta tu billetera para ver el historial',
      bet_now: 'Apostar Ahora',
      total_draws: 'Total de Sorteos',
      total_sales: 'Ventas Totales',
      total_prizes: 'Premios Totales',
      total_players: 'Total de Jugadores',
      number_frequency: 'Frecuencia de Números',
      times: 'veces',
      quantum_security: {
        title: 'Garantía de Seguridad Cuántica',
    ...
    movies_page: {
      ...
      subtitle: 'Descubre grandes películas, disfruta la experiencia',
      steps: {
      ...
      select_showtime_btn: 'Seleccionar Horario',
      select_showtime_for: 'Seleccionar Horario - {{title}}',
      back_to_movies: 'Volver a la Lista',
      cinema: 'Cine',
      ...
      language: 'Idioma',
      sold_out: 'Agotado',
      select_seats_btn: 'Seleccionar Asientos',
      select_seats_title: 'Seleccionar Asientos',
      back_to_showtimes: 'Volver a Horarios',
      screen: 'Pantalla',
      seat_selection_dev: 'Selección de asientos en desarrollo...',
      total: 'Total',
      confirm_seats: 'Confirmar Asientos',
      confirm_order: 'Confirmar Pedido',
      back_to_seats: 'Volver a Selección',
    ...
    hotels_page: {
      ...
      subtitle: 'Descubre hoteles boutique con reserva segura cuántica',
      destination: 'Destino',
      destination_placeholder: 'Ciudad, nombre de hotel o punto de referencia',
      check_in: 'Entrada',
      check_out: 'Salida',
      guests_rooms: 'Huéspedes y Habitaciones',
      ...
      select_room: 'Seleccionar Tipo de Habitación',
      max_guests: 'Máx {{count}} huéspedes',
      rooms_left: '{{count}} habitaciones restantes',
    ...
    flights_page: {
      ...
      subtitle: 'Reserva vuelos con transacciones seguras cuánticas',
      ...
      searching: 'Buscando...',
      outbound_flights: 'Vuelos de Ida',
      return_flights: 'Vuelos de Regreso',
      select_flight: 'Seleccionar',
      duration: 'Duración',
      stops: 'Escalas',
      direct: 'Directo',
      stop: 'escala',
      ...
      select_fare: 'Seleccionar Tarifa',
    ...
    market_page: {
      ...
      subtitle: 'Plataforma de trading segura basada en cifrado cuántico',
      trading_pairs: 'Pares de Trading',
      ...
      trading_panel: 'Panel de Trading',
      spot: 'Spot',
      margin: 'Margen',
      futures: 'Futuros',
      buy: 'Comprar',
      ...
      assets: 'Activos',
      no_orders: 'Sin órdenes pendientes',
      no_history: 'Sin historial de órdenes',
      no_positions: 'Sin posiciones',
      cancel: 'Cancelar',
      unfilled: 'Sin Ejecutar',
      partial: 'Parcial',
    ...
    crowdfunding_page: {
      ...
      subtitle: 'Apoya proyectos innovadores, crea un futuro mejor juntos',
      create_project: 'Iniciar Crowdfunding',
      search: 'Buscar',
      search_placeholder: 'Buscar proyectos innovadores...',
      featured: 'Destacado',
      days_left: 'días restantes',
      quantum_security: 'Seguridad Cuántica',
      anonymous: 'Anónimo',
      funding_progress: 'Progreso de Financiación',
      raised: 'Recaudado',
      backers: 'Patrocinadores',
      days_remaining: 'Días Restantes',
      support: 'Apoyar',
      no_results: 'No se encontraron proyectos',
      try_different_search: 'Intenta ajustar los criterios de búsqueda o explora otras categorías',
    ...
    concerts_page: {
      title: 'Conciertos Globales',
      subtitle: 'Descubre espectáculos increíbles, siente la magia de la música',
      search: 'Buscar',
      seats: 'asientos',
      from: 'desde',
      view_details: 'Ver Detalles',
      concert_details: 'Detalles del Concierto',
      back_to_list: 'Volver a la Lista',
      artist_info: 'Info del Artista',
      show_info: 'Info del Show',
      description: 'Descripción',
      expected_setlist: 'Setlist Esperado',
      more: 'más',
      select_ticket: 'Seleccionar Entrada',
      service_fee: 'cargo por servicio',
      remaining_tickets: 'Restantes',
      benefits: 'Beneficios',
      select_this_ticket: 'Seleccionar Esta Entrada',
      confirm_booking: 'Confirmar Reserva',
      ...
      payment_note: 'Paga con tokens QAU seguros cuánticamente para transacciones seguras.',
      ...
      form: {
        name: 'Nombre',
        name_placeholder: 'Ingresa tu nombre real',
        email: 'Email',
        email_placeholder: 'Ingresa tu email',
        phone: 'Teléfono',
        phone_placeholder: 'Ingresa tu número de teléfono',
        id_number: 'Número de ID',
        id_placeholder: 'Venta nominativa, ingresa número de ID',
    ...
    utilities_page: {
      ...
      searching: 'Buscando...',
      found_providers: 'Se encontraron {{count}} proveedores de electricidad',
      search_again: 'Buscar de Nuevo',
      query_bill: 'Consultar Factura',
      ...
      form: {
        ...
        region_placeholder: 'Ingresa provincia o estado',
    ...
    apps_page: {
      ...
      subtitle: 'Descubre aplicaciones descentralizadas impulsadas por la Red Cuántica',
    ...
    support_help: {
      ...
      subtitle: 'Obtenga soporte técnico profesional para resolver problemas al usar Quantaureum',
      view_help: 'Ver Ayuda',
      quick_help: {
        title: 'Ayuda Rápida',
      ...
      knowledge: {
        ...
        subtitle: 'Guías de usuario detalladas y documentación técnica',
        view_guide: 'Ver Guía',
    ...
    developer_docs: {
      ...
      examples: {
        ...
        subtitle: 'Ejemplos prácticos para comenzar rápidamente',
      ...
      whitepaper_page: {
        ...
        toc: {
          ...
          items: [
            ...
            { title: 'Tecnología de Seguridad Cuántica', page: '8' },
            { title: 'Diseño de Arquitectura Blockchain', page: '15' },
            { title: 'Mecanismo de Consenso', page: '22' },
            { title: 'Sistema de Evolución Autónoma IA', page: '28' },
            { title: 'Máquina Virtual de Contratos Inteligentes', page: '35' },
            { title: 'Interoperabilidad Cross-Chain', page: '42' },
            { title: 'Ecosistema de Aplicaciones', page: '48' },
            { title: 'Modelo Económico', page: '55' },
    ...
    post_detail: {
      ...
      no_comments: '¡Sin comentarios aún, sé el primero en comentar!',
      time: {
        just_now: 'Ahora mismo',
        minutes_ago: 'hace {{count}} minutos',
        hours_ago: 'hace {{count}} horas',
    ...
    topic_page: {
      ...
      reply: 'Responder',
      share: 'Compartir',
      replies_title: 'Respuestas ({{count}})',
    ...
    forum_category: {
      ...
      sample_posts: {
        ...
        technical: 'Optimización de Algoritmos Post-Cuánticos',
