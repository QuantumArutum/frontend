...
export default function TransactionsPage() {
  ...
  const getStatusText = (status: string | undefined) => {
    switch (status) {
      case 'success':
        return t('explorer.transactions.status.success');
      case 'failed':
        return t('explorer.transactions.status.failed');
      default:
        return t('explorer.transactions.status.pending');
    }
  };
            ...
            <thead>
              <tr className="border-b border-white/10 bg-white/5">
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">
                  {t('explorer.transactions.columns.hash')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">
                  {t('explorer.transactions.columns.block')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">
                  {t('explorer.transactions.columns.age')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">
                  {t('explorer.transactions.columns.from')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">
                  {t('explorer.transactions.columns.to')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">
                  {t('explorer.transactions.columns.value')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">
                  {t('explorer.transactions.status.title')}
                </th>
              </tr>
            </thead>
