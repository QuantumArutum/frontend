    ...
    <div className="max-w-7xl mx-auto px-5">
      ...
      >
        {[
          ...
          {
            label: t('explorer.contracts.stats.verified'),
            value: '892',
            color: 'text-emerald-400',
          },
          {
            label: t('explorer.contracts.stats.interactions'),
            value: '45.2K',
            color: 'text-cyan-400',
          },
            ...
            <thead>
              <tr className="border-b border-white/10">
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">
                  {t('explorer.contracts.columns.name')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">
                  {t('explorer.contracts.columns.address')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">
                  {t('explorer.contracts.columns.type')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">
                  {t('explorer.contracts.columns.status')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">
                  {t('explorer.contracts.columns.balance')}
                </th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">
                  {t('explorer.contracts.columns.txns')}
                </th>
              </tr>
            </thead>
            <tbody>
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center ${getContractColor(contract.type)}`}
                      >
                  ...
                  <td className="px-6 py-4">
                    <span className="text-indigo-400 hover:text-indigo-300 cursor-pointer font-mono text-sm">
                  ...
                  <td className="px-6 py-4">
                    {contract.verified ? (
                      ...
                      <span className="text-gray-500 text-xs">
                        {t('explorer.contracts.unverified')}
                      </span>
                    )}
                  </td>
                  <td className="px-6 py-4 text-gray-300 font-mono text-sm">
                    {contract.balance} QAU
                  </td>
