...
export default function GovernancePage() {
  ...
  const getStatusText = (status: string) => {
    switch (status) {
      case 'active':
        return t('governance_page.status.active');
      case 'pending':
        return t('governance_page.status.pending');
      case 'discussion':
        return t('governance_page.status.discussion');
      case 'passed':
        return t('governance_page.status.passed');
      case 'rejected':
        return t('governance_page.status.rejected');
      default:
        return t('governance_page.status.unknown');
    }
  };
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-2 border border-white/20">
            <div className="flex gap-2">
              {(['proposals', 'delegates', 'create'] as const).map((tab) => (
                ...
                >
                  {tab === 'proposals'
                    ? t('governance_page.tabs.proposals')
                    : tab === 'delegates'
                      ? t('governance_page.tabs.delegates')
                      : t('governance_page.tabs.create')}
                </button>
              ))}
            </div>
          </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span
                        className={`px-3 py-1 bg-gradient-to-r ${getStatusColor(proposal.status)} text-white text-sm rounded-full font-medium`}
                      >
                  ...
                  {proposal.status === 'active' && (
                    <div className="ml-6 text-right">
                      ...
                      <div className="text-sm text-gray-400">
                        {t('governance_page.voting.support_rate')}
                      </div>
                    </div>
                  )}
                </div>
                ...
                {proposal.status === 'active' && (
                  <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-400">
                        {t('governance_page.voting.against')}
                      </div>
                    </div>
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-400">
                        {t('governance_page.voting.abstain')}
                      </div>
                    </div>
                  </div>
                )}
            ...
            {delegates.map((delegate) => (
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">
                      {t('governance_page.delegates.delegated_votes')}
                    </span>
                    <span className="text-white font-medium">
                      {delegate.delegatedVotes.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">
                      {t('governance_page.delegates.participation')}
                    </span>
                    <span className="text-white font-medium">{delegate.participationRate}%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">
                      {t('governance_page.delegates.followers')}
                    </span>
                    <span className="text-white font-medium">
                      {delegate.followers.toLocaleString()}
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  {delegating === delegate.id
                    ? t('governance_page.delegates.delegating')
                    : t('governance_page.delegates.delegate_to')}
                </button>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <h2 className="text-2xl font-bold text-white mb-6">
                {t('governance_page.create_form.title')}
              </h2>

              <form onSubmit={handleSubmitProposal} className="space-y-6">
                <div>
                  <label className="block text-white font-medium mb-2">
                    {t('governance_page.create_form.proposal_title')}
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-white font-medium mb-2">
                    {t('governance_page.create_form.category')}
                  </label>
                  <select
                  ...
                  >
                    ...
                    <option value="economy">
                      {t('governance_page.create_form.categories.economy')}
                    </option>
                    <option value="ecosystem">
                      {t('governance_page.create_form.categories.ecosystem')}
                    </option>
                    <option value="governance">
                      {t('governance_page.create_form.categories.governance')}
                    </option>
                    <option value="security">
                      {t('governance_page.create_form.categories.security')}
                    </option>
                  </select>
                </div>
                ...
                <div>
                  <label className="block text-white font-medium mb-2">
                    {t('governance_page.create_form.description')}
                  </label>
                  <textarea
                ...
                <div>
                  <label className="block text-white font-medium mb-2">
                    {t('governance_page.create_form.tags')}
                  </label>
                  <input
                    type="text"
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  <h3 className="text-white font-medium mb-2">
                    {t('governance_page.create_form.requirements.title')}
                  </h3>
                ...
                >
                  ...
                  {submitting
                    ? t('governance_page.create_form.submitting')
                    : t('governance_page.create_form.submit')}
                </button>
              </form>
            </div>
          </motion.div>
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">
              {t('governance_page.process.title')}
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              {
                icon: '1',
                title: t('governance_page.process.steps.create.title'),
                desc: t('governance_page.process.steps.create.desc'),
                color: 'from-purple-500 to-pink-500',
              },
              {
                icon: '2',
                title: t('governance_page.process.steps.discussion.title'),
                desc: t('governance_page.process.steps.discussion.desc'),
                color: 'from-blue-500 to-cyan-500',
              },
              {
                icon: '3',
                title: t('governance_page.process.steps.voting.title'),
                desc: t('governance_page.process.steps.voting.desc'),
                color: 'from-green-500 to-emerald-500',
              },
              {
                icon: '4',
                title: t('governance_page.process.steps.execution.title'),
                desc: t('governance_page.process.steps.execution.desc'),
              ...
              >
                <div
                  className={`w-16 h-16 mx-auto mb-4 bg-gradient-to-r ${step.color} rounded-full flex items-center justify-center text-white font-bold text-xl`}
                >
                  {step.icon}
                </div>
