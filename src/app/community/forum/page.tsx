              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    {t('community_page.forum.stats.total_posts')}
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    {t('community_page.forum.stats.topics')}
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    {t('community_page.forum.stats.members')}
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    {t('community_page.forum.stats.online_now')}
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="flex-1 p-6">
                      ...
                      <div className="flex items-center gap-6 mt-4 text-sm">
                        <div className="text-gray-400">
                          ...
                          {t('community_page.forum.posts')}
                        </div>
                        <div className="text-gray-400">
                          <span className="text-white font-medium">
                            {category.topics.toLocaleString()}
                          </span>{' '}
                          {t('community_page.forum.topics_label')}
                        </div>
                        <div className="text-gray-400 flex-1 text-right">
                          {category.lastPost ? (
                            <>
                              {t('community_page.forum.latest')}:{' '}
                              <span className="text-cyan-400">{category.lastPost.title}</span>
                              <span className="text-gray-500">
                                {' '}
                                by {category.lastPost.author} ·{' '}
                                {new Date(category.lastPost.time).toLocaleString()}
                              </span>
                            </>
                          ) : (
                            <span className="text-gray-500">
                              {t('community_page.forum.no_posts')}
                            </span>
                          )}
                        </div>
                      </div>
