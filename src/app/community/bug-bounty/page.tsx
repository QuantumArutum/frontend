...
export default function BugBountyPage() {
  ...
  const severityLevels = [
    {
      level: t('community_sub.bug_bounty.severity.critical.level'),
      reward: t('community_sub.bug_bounty.severity.critical.reward'),
      color: 'from-red-500 to-rose-500',
      description: t('community_sub.bug_bounty.severity.critical.desc'),
    },
    {
      level: t('community_sub.bug_bounty.severity.high.level'),
      reward: t('community_sub.bug_bounty.severity.high.reward'),
      color: 'from-orange-500 to-amber-500',
      description: t('community_sub.bug_bounty.severity.high.desc'),
    },
    {
      level: t('community_sub.bug_bounty.severity.medium.level'),
      reward: t('community_sub.bug_bounty.severity.medium.reward'),
      color: 'from-yellow-500 to-lime-500',
      description: t('community_sub.bug_bounty.severity.medium.desc'),
    },
    {
      level: t('community_sub.bug_bounty.severity.low.level'),
      reward: t('community_sub.bug_bounty.severity.low.reward'),
      color: 'from-green-500 to-emerald-500',
      description: t('community_sub.bug_bounty.severity.low.desc'),
    },
  ];

  const inScope = t('community_sub.bug_bounty.scope.items_in', { returnObjects: true }) as string[];
  const outOfScope = t('community_sub.bug_bounty.scope.items_out', {
    returnObjects: true,
  }) as string[];
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white mb-1">
                  {t('community_sub.bug_bounty.title')}
                </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 text-center">
              ...
              <div className="text-sm text-gray-400">
                {t('community_sub.bug_bounty.stats.rewards_paid')}
              </div>
            </div>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 text-center">
              ...
              <div className="text-sm text-gray-400">
                {t('community_sub.bug_bounty.stats.bugs_fixed')}
              </div>
            </div>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 text-center">
              ...
              <div className="text-sm text-gray-400">
                {t('community_sub.bug_bounty.stats.researchers')}
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-white mb-4">
              {t('community_sub.bug_bounty.reward_levels')}
            </h2>
          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl p-6 border border-cyan-500/20 text-center">
            <h3 className="text-xl font-semibold text-white mb-2">
              {t('community_sub.bug_bounty.found_bug')}
            </h3>
