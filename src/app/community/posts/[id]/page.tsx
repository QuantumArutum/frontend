...
export default function PostDetailPage() {
  ...
  const handleComment = async () => {
    ...
    try {
      const res = await barongAPI.post(`/public/community/posts/${id}/comments`, {
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-8">
          <Card className="bg-gray-900 border-gray-800 text-white mb-6">
            ...
            <div
              className="text-lg mb-8 whitespace-pre-wrap leading-relaxed"
              style={{ color: 'white' }}
            >
              {post.content}
            </div>
            ...
            <div className="flex gap-4">
              ...
              <Button
                ...
                className="bg-transparent text-gray-300 border-gray-600"
              >
