  ...
  const loadProfile = useCallback(async () => {
    ...
    try {
      const response = await barongAPI.get(
        `/public/community/user-profile?userId=${currentUser.id}`
      );
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* 显示名称 */}
              <div>
                <label className="block text-white font-medium mb-2">显示名称</label>
                <input
                  type="text"
                  name="displayName"
                ...
                />
                <p className="mt-1 text-sm text-white/60">{formData.displayName.length}/100 字符</p>
              </div>

              {/* 个人简介 */}
              <div>
                <label className="block text-white font-medium mb-2">个人简介</label>
                <textarea
                  name="bio"
                  value={formData.bio}
                  onChange={handleInputChange}
                  ...
                  placeholder="介绍一下自己..."
                />
                <p className="mt-1 text-sm text-white/60">{formData.bio.length}/500 字符</p>
              </div>
              ...
              {/* 网站 */}
              <div>
                <label className="block text-white font-medium mb-2">网站</label>
                <input
                  type="url"
                  name="website"
              ...
              {/* 社交链接 */}
              <div>
                <label className="block text-white font-medium mb-4">社交链接</label>
