      ...
      <div className="relative z-10 max-w-4xl mx-auto p-8 pt-24">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-white mb-4">{t('profile_page.basic_info')}</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-4">{t('profile_page.security_settings')}</h3>
              <div className="space-y-4">
