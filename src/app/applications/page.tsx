            ...
            >
              ...
              >
                ...
                <span
                  ...
                  style={{
                    backgroundImage: `linear-gradient(135deg, ${colors.accent.cyan}, ${colors.secondary})`,
                  }}
                >
                  {' '}
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {stats.map((stat, i) => (
                  ...
                  >
                    <div className="text-2xl font-bold" style={{ color: colors.accent.cyan }}>
                      {stat.value}
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2
                ...
                style={{ color: colors.text.primary }}
              >
                {t('applications_page.bridge.title')}
              </h2>
            ...
            >
              <h3
                ...
                style={{ color: colors.text.primary }}
              >
                {t('applications_page.bridge.supported_chains')}
              </h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2
                ...
                style={{ color: colors.text.primary }}
              >
                {t('applications_page.enterprise.title')}
              </h2>
              <p className="text-lg max-w-2xl mx-auto" style={{ color: colors.text.secondary }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {solution.features.map((feature, i) => (
                          <span
                            ...
                            style={{ background: colors.glass.medium, color: colors.text.muted }}
                          >
                            {feature}
                          </span>
                        ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2
                ...
                style={{ color: colors.text.primary }}
              >
                {t('applications_page.use_cases.title')}
              </h2>
              <p className="text-lg max-w-2xl mx-auto" style={{ color: colors.text.secondary }}>
        ...
        <section className="py-20 bg-white/5">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div
              ...
              style={{
                background: `linear-gradient(135deg, ${colors.accent.cyan}20, ${colors.secondary}20)`,
                border: `1px solid ${colors.glass.border}`,
              }}
            >
              <h2 className="text-3xl font-bold mb-4" style={{ color: colors.text.primary }}>
                {t('applications_page.cta.title')}
              </h2>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${colors.accent.cyan}, ${colors.secondary})`,
