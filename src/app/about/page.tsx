          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-quantum-secondary text-lg mb-6">{t('about.mission.desc1')}</p>
                <p className="text-quantum-secondary text-lg">{t('about.mission.desc2')}</p>
              </div>
              <div className="quantum-card p-8">
                <div className="text-center">
                  ...
                  <p className="text-quantum-secondary">{t('about.mission.card.desc')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="quantum-card p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-quantum-light mb-2">
                  {t('about.vision.safety.title')}
                </h3>
                <p className="text-quantum-secondary">{t('about.vision.safety.desc')}</p>
              </div>
              ...
              <div className="quantum-card p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-quantum-light mb-2">
                  {t('about.vision.user.title')}
                </h3>
                <p className="text-quantum-secondary">{t('about.vision.user.desc')}</p>
              </div>
              ...
              <div className="quantum-card p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-quantum-light mb-2">
                  {t('about.vision.innovation.title')}
                </h3>
                <p className="text-quantum-secondary">{t('about.vision.innovation.desc')}</p>
              </div>
            </div>
          </div>
        </section>
