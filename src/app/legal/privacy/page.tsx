    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] to-[#1a1a2e]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <p className="text-gray-300 leading-relaxed">
                {t(
                  'legal.privacy.overview.content',
                  'Quantaureum ("we") takes your privacy very seriously. This privacy policy explains how we collect, use, disclose and protect your personal information. By using our services, you agree to the practices described in this privacy policy.'
                )}
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                <h3 className="text-lg font-semibold text-white mb-3">
                  {t('legal.privacy.collection.provided.title', 'Information You Provide')}
                </h3>
                <ul className="text-gray-300 space-y-2">
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.provided.item1',
                  ...
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.provided.item2',
                  ...
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.provided.item3',
                  ...
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.provided.item4',
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                <h3 className="text-lg font-semibold text-white mb-3">
                  {t(
                    'legal.privacy.collection.automatic.title',
                ...
                <ul className="text-gray-300 space-y-2">
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.automatic.item1',
                  ...
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.automatic.item2',
                  ...
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.automatic.item3',
                  ...
                  <li>
                    •{' '}
                    {t(
                      'legal.privacy.collection.automatic.item4',
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <ul className="text-gray-300 space-y-3">
                <li>
                  • {t('legal.privacy.use.item1', 'Provide, maintain and improve our services')}
                </li>
                <li>
                  •{' '}
                  {t(
                    'legal.privacy.use.item2',
                ...
                <li>
                  •{' '}
                  {t(
                    'legal.privacy.use.item5',
                    'Detect, prevent and resolve fraud and security issues'
                  )}
                </li>
                ...
                <li>
                  •{' '}
                  {t(
                    'legal.privacy.use.item7',
                    'Conduct research and analysis to improve services'
                  )}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              ...
              <ul className="text-gray-300 space-y-2">
                <li>
                  •{' '}
                  {t(
                    'legal.privacy.security.item1',
                    'Quantum-safe encryption technology to protect data transmission'
                  )}
                </li>
                <li>
                  • {t('legal.privacy.security.item2', 'Secure data storage and access controls')}
                </li>
                <li>
                  •{' '}
                  {t(
                    'legal.privacy.security.item3',
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">
              {t('legal.privacy.updates.title', 'Policy Updates')}
            </h2>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <p className="text-gray-300 leading-relaxed">
                {t(
                  'legal.privacy.updates.content',
                  'We may update this privacy policy from time to time. Updated policies will be posted on this page with the last updated date noted. We recommend that you review this policy regularly to stay informed of any changes. Continued use of our services indicates your acceptance of the updated policy.'
                )}
              </p>
            </div>
          </section>
