    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] to-[#1a1a2e]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <p className="text-gray-300 leading-relaxed">
                {t(
                  ...
                  'Cookies are small text files stored on your device that remember your preferences and improve your browsing experience. When you visit our website, we may place cookies on your device. These cookies help us understand how you use our services and enable us to provide you with a better experience.'
                )}
              </p>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                ...
                <p className="text-gray-300 mb-3">
                  {t(
                    'legal.cookies.types.essential.desc',
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                ...
                <p className="text-gray-300 mb-3">
                  {t(
                    'legal.cookies.types.functional.desc',
                ...
                <ul className="text-gray-400 space-y-1 text-sm">
                  ...
                  <li>
                    • {t('legal.cookies.types.functional.item3', 'User interface customization')}
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                ...
                <p className="text-gray-300 mb-3">
                  {t(
                    'legal.cookies.types.analytics.desc',
                    'These cookies help us understand how visitors interact with the website so we can improve our services.'
                  )}
                </p>
                <ul className="text-gray-400 space-y-1 text-sm">
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                ...
                <p className="text-gray-300 mb-3">
                  {t(
                    'legal.cookies.types.marketing.desc',
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">
              {t('legal.cookies.list.title', 'Specific Cookie List')}
            </h2>
                ...
                <thead className="bg-white/5">
                  <tr>
                    <th className="text-left text-white p-4">
                      {t('legal.cookies.list.name', 'Name')}
                    </th>
                    <th className="text-left text-white p-4">
                      {t('legal.cookies.list.type', 'Type')}
                    </th>
                    <th className="text-left text-white p-4">
                      {t('legal.cookies.list.duration', 'Duration')}
                    </th>
                    <th className="text-left text-white p-4">
                      {t('legal.cookies.list.purpose', 'Purpose')}
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/10">
                  <tr>
                    ...
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.types.essential.title', 'Essential')}
                    </td>
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.list.session', 'Session')}
                    </td>
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.list.session_mgmt', 'User session management')}
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.list.auth', 'Authentication')}
                    </td>
                  </tr>
                  <tr>
                    <td className="text-gray-300 p-4">locale</td>
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.types.functional.title', 'Functional')}
                    </td>
                    <td className="text-gray-400 p-4">1 {t('legal.cookies.list.year', 'year')}</td>
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.list.language', 'Language preference')}
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="text-gray-400 p-4">1 {t('legal.cookies.list.year', 'year')}</td>
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.list.theme', 'Theme settings')}
                    </td>
                  </tr>
                  <tr>
                    <td className="text-gray-300 p-4">_ga</td>
                    <td className="text-gray-400 p-4">
                      {t('legal.cookies.types.analytics.title', 'Analytics')}
                    </td>
                    <td className="text-gray-400 p-4">
                      2 {t('legal.cookies.list.years', 'years')}
                    </td>
              ...
              <ul className="text-gray-300 space-y-3">
                <li>
                  <strong className="text-white">
                    {t('legal.cookies.manage.browser.title', 'Browser Settings')}:
                  </strong>{' '}
                  {t(
                    'legal.cookies.manage.browser.desc',
                    'Most browsers allow you to control cookies through settings. You can choose to block all cookies or only third-party cookies.'
                  )}
                </li>
                <li>
                  <strong className="text-white">
                    {t('legal.cookies.manage.center.title', 'Cookie Preference Center')}:
                  </strong>{' '}
                  {t(
                    'legal.cookies.manage.center.desc',
                    'You can use the cookie preference center on our website to manage non-essential cookies.'
                  )}
                </li>
                <li>
                  <strong className="text-white">
                    {t('legal.cookies.manage.optout.title', 'Opt Out')}:
                  </strong>{' '}
                  {t(
                    'legal.cookies.manage.optout.desc',
                    'For analytics cookies, you can use the Google Analytics opt-out browser add-on.'
                  )}
                </li>
              </ul>
              <p className="text-yellow-400 mt-4 text-sm">
                {t(
                  'legal.cookies.manage.warning',
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">
              {t('legal.cookies.updates.title', 'Policy Updates')}
            </h2>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <p className="text-gray-300 leading-relaxed">
                {t(
                  'legal.cookies.updates.content',
                  'We may update this cookie policy from time to time. Any changes will be posted on this page with the last updated date noted. We recommend that you review this policy regularly to stay informed about how we use cookies.'
                )}
              </p>
            </div>
          </section>
