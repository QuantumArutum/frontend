...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      description: t('contact.info.support.desc'),
    },
    {
      icon: Globe,
      title: t('contact.info.website.title'),
      value: t('contact.info.website.value'),
      description: t('contact.info.website.desc'),
    },
    {
      icon: Clock,
  ...
  const offices = [
    {
      city: t('contact.offices.singapore.city'),
      address: t('contact.offices.singapore.address'),
      type: t('contact.offices.singapore.type'),
    },
    {
      city: t('contact.offices.sanfrancisco.city'),
      address: t('contact.offices.sanfrancisco.address'),
      type: t('contact.offices.sanfrancisco.type'),
    },
    {
      city: t('contact.offices.london.city'),
      address: t('contact.offices.london.address'),
      type: t('contact.offices.london.type'),
    },
  ];
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  style={{
                    backgroundImage: `linear-gradient(135deg, ${colors.secondary}, ${colors.accent.cyan})`,
                  }}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <p className="font-medium mb-1" style={{ color: colors.accent.cyan }}>
                    {info.value}
                  </p>
                ...
                {isSubmitted ? (
                  <div className="text-center py-12">
                    <div
                      ...
                      style={{ background: `${colors.accent.green}20` }}
                    >
                    ...
                    <button
                      ...
                      style={{ background: colors.glass.medium, color: colors.text.primary }}
                    >
                          ...
                          style={{
                            background:
                              formData.type === type.id
                                ? `${colors.secondary}30`
                                : colors.glass.medium,
                            border: `1px solid ${formData.type === type.id ? colors.secondary : colors.glass.border}`,
                          }}
                        >
                          <type.icon
                            ...
                            style={{
                              color:
                                formData.type === type.id ? colors.secondary : colors.text.muted,
                            }}
                          />
                          <span
                            className="text-xs"
              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    {offices.map((office, index) => (
                      <div
                        ...
                        style={{ background: colors.glass.medium }}
                      >
                        <div
                          className="p-2 rounded-lg"
                          style={{ background: `${colors.accent.cyan}20` }}
                        >
                        ...
                        <div>
                          ...
                          <span className="text-xs" style={{ color: colors.accent.cyan }}>
                            {office.type}
                          </span>
                        </div>
                      </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <a
                      href="/support/help"
                      className="ml-auto px-4 py-2 rounded-lg font-medium transition-all hover:scale-105"
                      style={{ background: colors.glass.medium, color: colors.text.primary }}
                    >
