...
const defaultProposals = [
  ...
  },
  {
    id: '3',
    title: '调整网络手续费结构',
    description: '提议调整当前的网络手续费结构，降低基础交易费用50%。',
    status: 'discussion',
    proposer: '用户体验委员会',
    proposerAvatar: 'UX',
    category: '经济模型',
  ...
  },
  {
    id: '4',
    title: '增加质押奖励年化率',
    description: '提议将当前质押奖励年化率从8%提升至12%。',
    status: 'passed',
    proposer: '经济委员会',
    proposerAvatar: 'EC',
    category: '经济模型',
    votes: { for: 1789456, against: 234567, abstain: 123456 },
    totalVotes: 2147479,
    quorum: 2000000,
    endDate: '2024-12-15',
    tags: ['质押奖励', '经济激励'],
  ...
  try {
    ...
    if (BACKEND_API_URL) {
      const response = await fetch(
        `${BACKEND_API_URL}/api/governance/${type}${status ? `?status=${status}` : ''}`
      );
