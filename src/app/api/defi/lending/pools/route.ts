...
const fallbackPools = [
  {
    ...
    total_borrowed: 3500000,
    supply_rate: 8.5,
    borrow_rate: 12.3,
    utilization_rate: 70,
    collateral_factor: 0.75,
    liquidation_threshold: 0.85,
    available_to_borrow: 1500000,
  },
  {
    pool_id: 'LEND-USDT',
    asset: 'USDT',
  ...
  },
  {
    ...
    collateral_factor: 0.8,
    liquidation_threshold: 0.88,
    available_to_borrow: 50,
  },
  {
    pool_id: 'LEND-USDC',
    asset: 'USDC',
    total_supply: 8000000,
    total_borrowed: 4800000,
    supply_rate: 5.5,
    borrow_rate: 8.8,
    utilization_rate: 60,
    collateral_factor: 0.85,
    liquidation_threshold: 0.9,
    available_to_borrow: 3200000,
  },
];
