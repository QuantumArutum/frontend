...
const getBugBountyTiers = (t: any) => [
  {
    severity: t('enterprise.audit.findings.critical'),
    reward: '$50,000 - $100,000',
    color: 'text-red-400',
    bgColor: 'bg-red-500/20',
  },
  {
    severity: t('enterprise.audit.findings.high'),
    reward: '$10,000 - $50,000',
    color: 'text-orange-400',
    bgColor: 'bg-orange-500/20',
  },
  {
    severity: t('enterprise.audit.findings.medium'),
    reward: '$2,000 - $10,000',
    color: 'text-yellow-400',
    bgColor: 'bg-yellow-500/20',
  },
  {
    severity: t('enterprise.audit.findings.low'),
    reward: '$500 - $2,000',
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                ...
                <span className="bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent">
                  {' '}
                  {t('enterprise.audit.hero.title_highlight')}{' '}
                </span>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.audit.reports.title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.audit.reports.subtitle')}
            </p>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-4 text-sm">
                        <span className="text-gray-300">
                          {t('enterprise.audit.auditor')}:{' '}
                          <span className="text-white font-medium">{report.auditor}</span>
                        </span>
                        <span className="text-gray-300">
                          {t('enterprise.audit.date')}:{' '}
                          <span className="text-white">{report.date}</span>
                        </span>
                        <span className="text-gray-300">
                          {t('enterprise.audit.score')}:{' '}
                          <span className="text-green-400 font-bold">{report.score}</span>
                        </span>
                      </div>
                    </div>
        ...
        <section className="py-16 px-4 bg-black/30">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.audit.certifications.title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.audit.certifications.subtitle')}
            </p>
              ...
              {certifications.map((cert, index) => (
                ...
                >
                  ...
                  <div className="text-xs text-gray-500">
                    <div>
                      {t('enterprise.audit.certifications.issuer')}: {cert.issuer}
                    </div>
                    <div>
                      {t('enterprise.audit.certifications.valid_until')}: {cert.validUntil}
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.audit.features.title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.audit.features.subtitle')}
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <section className="py-16 px-4 bg-black/30">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.audit.bounty.title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.audit.bounty.subtitle')}
            </p>
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {bugBountyTiers.map((tier, index) => (
                  <div
                    key={index}
                    className={`${tier.bgColor} rounded-xl p-4 flex items-center justify-between`}
                  >
              ...
              <div className="text-center">
                <p className="text-gray-300 mb-6">{t('enterprise.audit.bounty.desc')}</p>
