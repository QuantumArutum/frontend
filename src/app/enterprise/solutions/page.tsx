...
const getSolutions = (t: any): Solution[] => [
  {
    ...
    features: t('enterprise.solutions.finance.features', {
      returnObjects: true,
    }) as unknown as string[],
    benefits: t('enterprise.solutions.finance.benefits', {
      returnObjects: true,
    }) as unknown as string[],
  ...
  },
  {
    ...
    features: t('enterprise.solutions.supply_chain.features', {
      returnObjects: true,
    }) as unknown as string[],
    benefits: t('enterprise.solutions.supply_chain.benefits', {
      returnObjects: true,
    }) as unknown as string[],
  ...
  },
  {
    ...
    features: t('enterprise.solutions.healthcare.features', {
      returnObjects: true,
    }) as unknown as string[],
    benefits: t('enterprise.solutions.healthcare.benefits', {
      returnObjects: true,
    }) as unknown as string[],
  },
  {
    ...
    features: t('enterprise.solutions.government.features', {
      returnObjects: true,
    }) as unknown as string[],
    benefits: t('enterprise.solutions.government.benefits', {
      returnObjects: true,
    }) as unknown as string[],
  },
];
...
const getDeploymentOptions = (t: any): DeploymentOption[] => [
  {
    ...
    features: t('enterprise.solutions.deployment.cloud.features', {
      returnObjects: true,
    }) as unknown as string[],
  },
  {
    ...
    features: t('enterprise.solutions.deployment.private.features', {
      returnObjects: true,
    }) as unknown as string[],
  },
  {
    ...
    features: t('enterprise.solutions.deployment.hybrid.features', {
      returnObjects: true,
    }) as unknown as string[],
  },
];
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">
                            {solution.description.slice(0, 30)}...
                          </p>
                        </div>
                      </div>
                    </motion.button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <ul className="space-y-2">
                        {Array.isArray(selectedSolution.features) &&
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {Array.isArray(selectedSolution.benefits) &&
        ...
        <section className="py-16 px-4 bg-black/30">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.solutions.deployment.title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.solutions.deployment.subtitle')}
            </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-white mb-4">
                {t('enterprise.solutions.cta.title')}
              </h2>
