...
const getPartnerTypes = (t: any) => [
  {
    ...
    benefits: t('enterprise.partners.types.technology.benefits', {
      returnObjects: true,
    }) as string[],
    examples: t('enterprise.partners.types.technology.examples', {
      returnObjects: true,
    }) as string[],
  },
  {
    ...
    benefits: t('enterprise.partners.types.developer.benefits', {
      returnObjects: true,
    }) as string[],
    examples: t('enterprise.partners.types.developer.examples', {
      returnObjects: true,
    }) as string[],
  },
  {
...
const getPartnerLevels = (t: any) => [
  {
    ...
    requirements: t('enterprise.partners.levels.registered.requirements', {
      returnObjects: true,
    }) as string[],
    benefits: t('enterprise.partners.levels.registered.benefits', {
      returnObjects: true,
    }) as string[],
  },
  {
    ...
    requirements: t('enterprise.partners.levels.silver.requirements', {
      returnObjects: true,
    }) as string[],
  ...
  },
  {
    ...
    requirements: t('enterprise.partners.levels.gold.requirements', {
      returnObjects: true,
    }) as string[],
  ...
  },
  {
    ...
    requirements: t('enterprise.partners.levels.platinum.requirements', {
      returnObjects: true,
    }) as string[],
    benefits: t('enterprise.partners.levels.platinum.benefits', {
      returnObjects: true,
    }) as string[],
  },
];
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                ...
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  {' '}
                  {t('enterprise.partners.hero.title_highlight')}{' '}
                </span>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.partners.types_title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.partners.types_subtitle')}
            </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <h4 className="text-sm font-semibold text-gray-300 mb-2">
                          {t('enterprise.partners.benefits.title')}
                        </h4>
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-300 mb-2">
                          {t('enterprise.partners.suitable_for')}
                        </h4>
                        <ul className="space-y-1">
        ...
        <section className="py-16 px-4 bg-black/30">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.partners.featured_title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.partners.featured_subtitle')}
            </p>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.partners.benefits.subtitle')}
            </p>
        ...
        <section className="py-16 px-4 bg-black/30">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-white text-center mb-4">
              {t('enterprise.partners.levels_title')}
            </h2>
            <p className="text-gray-400 text-center mb-12">
              {t('enterprise.partners.levels_subtitle')}
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {partnerLevels.map((level, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-gray-300 mb-2">
                        {t('enterprise.partners.requirements')}
                      </h4>
                      <ul className="space-y-1">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-white mb-4">
                {t('enterprise.partners.cta.title')}
              </h2>
