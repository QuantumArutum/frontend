        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-xl p-6">
            <h2 className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
              {darkMode ? <Moon className="w-5 h-5" /> : <Sun className="w-5 h-5" />} {t('settings_page.appearance.title')}
            </h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white font-medium">{t('settings_page.appearance.dark_mode')}</p>
                  <p className="text-gray-400 text-sm">{t('settings_page.appearance.dark_mode_desc')}</p>
                </div>
                <button
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{t('settings_page.notifications.push_desc')}</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{t('settings_page.notifications.sound_desc')}</p>
                </div>
                <button
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{t('settings_page.language.interface_desc')}</p>
                </div>
                <select
                  value={language}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{t('settings_page.security.two_factor_desc')}</p>
                </div>
                <span className="text-green-400">{t('settings_page.security.enabled')}</span>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white font-medium">{t('settings_page.security.quantum_encryption')}</p>
                  <p className="text-gray-400 text-sm">{t('settings_page.security.quantum_encryption_desc')}</p>
                </div>
                <span className="text-green-400">{t('settings_page.security.enabled')}</span>
              </div>
