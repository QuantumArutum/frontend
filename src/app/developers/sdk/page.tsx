        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="quantum-card p-8 text-center relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-quantum-light mb-4">{t('sdk_page.sdks.typescript.title')}</h3>
            ...
            <div className="quantum-card p-8 text-center relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-quantum-light mb-4">{t('sdk_page.sdks.python.title')}</h3>
              <p className="text-quantum-secondary mb-6">
            ...
            <div className="quantum-card p-8 text-center relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-quantum-light mb-4">{t('sdk_page.sdks.go.title')}</h3>
              <p className="text-quantum-secondary mb-6">
                {t('sdk_page.sdks.go.description')}
              </p>
              <div className="space-y-4">
                <div className="text-sm text-quantum-accent">
            ...
            <div className="quantum-card p-8 text-center relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-quantum-light mb-4">{t('sdk_page.sdks.rust.title')}</h3>
              <p className="text-quantum-secondary mb-6">
                {t('sdk_page.sdks.rust.description')}
              </p>
              <div className="space-y-4">
                <div className="text-sm text-quantum-accent">
            ...
            <div className="quantum-card p-8 text-center relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-quantum-light mb-4">{t('sdk_page.sdks.java.title')}</h3>
              <p className="text-quantum-secondary mb-6">
                {t('sdk_page.sdks.java.description')}
              </p>
              <div className="space-y-4">
                <div className="text-sm text-quantum-accent">
            ...
            <div className="quantum-card p-8 text-center relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-quantum-light mb-4">{t('sdk_page.sdks.cpp.title')}</h3>
              <p className="text-quantum-secondary mb-6">
                {t('sdk_page.sdks.cpp.description')}
              </p>
              <div className="space-y-4">
                <div className="text-sm text-quantum-accent">
      ...
      <section className="py-16 bg-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-quantum-light mb-6">{t('sdk_page.requirements.title')}</h2>
          ...
          <div className="quantum-card p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold text-quantum-light mb-4">{t('sdk_page.requirements.minimum.title')}</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-quantum-light mb-4">{t('sdk_page.requirements.recommended.title')}</h3>
                <div className="space-y-3 text-quantum-secondary">
                  <div className="flex items-center space-x-3">
