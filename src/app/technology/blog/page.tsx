  ...
  const blogPosts = [
    {
      ...
      excerpt: t('blog.posts.quantum.excerpt', '探讨量子计算对传统密码学的威胁，以及Quantaureum如何提供解决方案。'),
      date: '2024-01-15',
    ...
    },
    {
      ...
      excerpt: t('blog.posts.dilithium.excerpt', '深入了解我们采用的后量子数字签名算法及其技术优势。'),
      date: '2024-01-10',
    ...
    },
    {
      ...
      excerpt: t('blog.posts.crosschain.excerpt', '介绍Quantaureum如何在保证量子安全的前提下实现跨链功能。'),
      date: '2024-01-05',
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            <div className="bg-gradient-to-r from-purple-600/20 to-cyan-600/20 backdrop-blur-md rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                {t('blog.featured.excerpt', '经过两年的精心开发和测试，Quantaureum主网今日正式上线。这标志着全球首个企业级后量子密码学区块链平台的诞生，为即将到来的量子计算时代提供了坚实的安全保障。')}
              </p>
              <a 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {blogPosts.map((post) => (
              <article key={post.id} className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:border-cyan-400/50 transition-all duration-200">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <a href="/technology/blog/category/security" className="bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 px-4 py-3 rounded-lg text-center transition-colors">
                {t('blog.categories.security', '安全')}
              </a>
              <a href="/technology/blog/category/technology" className="bg-cyan-600/20 hover:bg-cyan-600/30 text-cyan-300 px-4 py-3 rounded-lg text-center transition-colors">
                {t('blog.categories.technology', '技术')}
              </a>
              <a href="/technology/blog/category/innovation" className="bg-green-600/20 hover:bg-green-600/30 text-green-300 px-4 py-3 rounded-lg text-center transition-colors">
                {t('blog.categories.innovation', '创新')}
              </a>
              <a href="/technology/blog/category/research" className="bg-yellow-600/20 hover:bg-yellow-600/30 text-yellow-300 px-4 py-3 rounded-lg text-center transition-colors">
