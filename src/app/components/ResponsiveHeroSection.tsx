...
const ResponsiveHeroSection = () => {
  ...
  const stats = [
    { value: t('hero.stats.tps.value'), label: t('hero.stats.tps.label'), unit: t('hero.stats.tps.unit'), color: 'from-blue-400 to-cyan-400' },
    { value: t('hero.stats.score.value'), label: t('hero.stats.score.label'), unit: t('hero.stats.score.unit'), color: 'from-green-400 to-emerald-400' },
    { value: t('hero.stats.coverage.value'), label: t('hero.stats.coverage.label'), unit: t('hero.stats.coverage.unit'), color: 'from-purple-400 to-pink-400' },
    { value: t('hero.stats.languages.value'), label: t('hero.stats.languages.label'), unit: t('hero.stats.languages.unit'), color: 'from-orange-400 to-red-400' },
    { value: t('hero.stats.vulnerabilities.value'), label: t('hero.stats.vulnerabilities.label'), unit: t('hero.stats.vulnerabilities.unit'), color: 'from-teal-400 to-blue-400' },
    { value: t('hero.stats.availability.value'), label: t('hero.stats.availability.label'), unit: t('hero.stats.availability.unit'), color: 'from-indigo-400 to-purple-400' }
  ];
  ...
  const addQuantaureumNetwork = async () => {
    ...
    try {
      ...
      setErrorMessage((error as { message?: string })?.message || 'Connection failed, please try again');
    }
  };
  ...
  return (
    <section id="home" className="min-h-screen flex items-center py-24 px-5 relative overflow-hidden">
      {/* Background Effects */}
      ...
      >
        ...
        <div className="hero-content order-2 lg:order-1">
          ...
          >
            ...
            >
              <div className={`text-4xl font-bold bg-gradient-to-r ${stats[currentStat].color} bg-clip-text text-transparent`}>
      ...
      {showMetaMaskModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          >
            ...
            <div className="flex justify-center mb-6">
              <div className="w-20 h-20 bg-gradient-to-br from-orange-400 to-orange-600 rounded-2xl flex items-center justify-center">
                <svg className="w-12 h-12" viewBox="0 0 318.6 318.6">
                  ...
                  <path fill="#CD6116" d="M106.8 247.4l4.8-40.6-31.3.9zm100.2-40.6l4.8 40.6 26.5-39.7zm23.8-44.7l-56.2 2.5 5.2 28.9 8.3-17.4 20 9.1zm-120.2 23.1l20-9.1 8.2 17.4 5.3-28.9-56.3-2.5z"/>
            ...
            <h2 className="text-2xl font-bold text-white text-center mb-2">{t('hero.modal.title')}</h2>
            ...
            <div className="bg-black/30 rounded-xl p-4 mb-6">
              <div className="grid grid-cols-4 gap-3 text-center">
                <div className="bg-white/5 rounded-lg p-3">
                  <span className="text-gray-400 text-xs block mb-1">{t('hero.modal.network')}</span>
                  <span className="text-white font-medium text-sm">Quantaureum</span>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <span className="text-gray-400 text-xs block mb-1">{t('hero.modal.chainId')}</span>
            ...
            <div className="space-y-3">
              ...
              >
                {walletStatus === 'connecting' ? (
                  ...
                  <>{isMetaMaskInstalled() ? t('hero.modal.add_to_metamask') : t('hero.modal.install_metamask')}</>
                )}
              </button>
