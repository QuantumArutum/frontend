        ...
        <div className="text-center mb-16">
          ...
          >
            <span className="text-sm text-gray-400">
              <Trans
                i18nKey="gold.fee_info"
                components={[<span className="text-yellow-400" key="0" />]}
              />
            </span>
          </motion.div>
        </div>
        ...
        >
          <div className="rounded-3xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div>
                <div className="text-gray-400 mb-2 uppercase tracking-wider text-sm">
                  {t('gold.stats.reserve.label')}
                </div>
              ...
              <div>
                <div className="text-gray-400 mb-2 uppercase tracking-wider text-sm">
                  {t('gold.stats.price.label')}
                </div>
                <div
                  className={`text-4xl font-bold tabular-nums flex items-center justify-center gap-2 ${
