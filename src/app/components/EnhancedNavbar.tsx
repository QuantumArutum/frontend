...
const EnhancedNavbar = () => {
  ...
  const navItems = [
    ...
    { id: 'community', label: t('nav.community', 'Community'), href: '/community', isExternal: true }
  ];
  ...
  return (
    <>
              ...
              {navItems.map((item) => (
                item.isExternal ? (
                  ...
                  <button
                    ...
                    className={`relative px-3 py-2 rounded-lg transition-all duration-300 whitespace-nowrap ${activeSection === item.id
                  ...
                  >
                    ...
                    {activeSection === item.id && (
                      <div
                        className="absolute inset-0 bg-gradient-to-r from-[#6E3CBC]/20 to-[#00D4FF]/20 rounded-lg border border-cyan-500/30"
                      />
                    )}
                  </button>
                )
      ...
      {isMobileMenuOpen && (
        <div
          className="fixed top-[88px] left-0 right-0 z-40 bg-black/95 backdrop-blur-md border-b border-white/10 lg:hidden"
        >
              ...
              {navItems.map((item) => (
                item.isExternal ? (
                  ...
                  <button
                    key={item.id}
                    onClick={() => scrollToSection(item.id)}
                    className={`text-left px-4 py-3 rounded-lg transition-all duration-300 ${activeSection === item.id
