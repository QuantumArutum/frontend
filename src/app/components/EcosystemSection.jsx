      ...
      <section className="py-24 px-5 bg-white/5">
        ...
        <div className="relative max-w-7xl mx-auto" style={{ height: '650px' }}>
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 1 }}>
            {/* 垂直主线 */}
            <line x1="50%" y1="0" x2="50%" y2="100%" stroke="url(#gradient-main)" strokeWidth="3" strokeDasharray="10,5" className="animate-pulse" />
            
            {/* 水平连接线 */}
            <line x1="50%" y1="100" x2="35%" y2="100" stroke="url(#gradient-purple)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="100" x2="65%" y2="100" stroke="url(#gradient-emerald)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="200" x2="35%" y2="200" stroke="url(#gradient-emerald)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="200" x2="65%" y2="200" stroke="url(#gradient-blue)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="300" x2="35%" y2="300" stroke="url(#gradient-orange)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="300" x2="65%" y2="300" stroke="url(#gradient-purple)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="400" x2="35%" y2="400" stroke="url(#gradient-pink)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="400" x2="65%" y2="400" stroke="url(#gradient-purple)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="500" x2="35%" y2="500" stroke="url(#gradient-gray)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="500" x2="65%" y2="500" stroke="url(#gradient-red)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="600" x2="35%" y2="600" stroke="url(#gradient-blue)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            <line x1="50%" y1="600" x2="65%" y2="600" stroke="url(#gradient-purple)" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" />
            ...
            return (
              ...
              >
                <div className="relative group cursor-pointer transition-all duration-300 scale-100">
                  <div className={`relative w-80 h-64 p-6 bg-gradient-to-br ${colors.bg} backdrop-blur-sm rounded-2xl border ${colors.border} shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden`}>
                    {/* 量子树背景装饰 */}
                    <div className="absolute inset-0 opacity-10 pointer-events-none">
                      <svg className="w-full h-full" viewBox="0 0 320 256" fill="none">
                        ...
                        />
                        {/* 量子节点 */}
                        <circle cx="160" cy="120" r="3" fill="currentColor" className={`${colors.text} opacity-40`} />
                        <circle cx="140" cy="100" r="2" fill="currentColor" className={`${colors.text} opacity-40`} />
                        <circle cx="180" cy="100" r="2" fill="currentColor" className={`${colors.text} opacity-40`} />
                        <circle cx="130" cy="80" r="1.5" fill="currentColor" className={`${colors.text} opacity-40`} />
                        <circle cx="150" cy="80" r="1.5" fill="currentColor" className={`${colors.text} opacity-40`} />
                        <circle cx="170" cy="80" r="1.5" fill="currentColor" className={`${colors.text} opacity-40`} />
                        <circle cx="190" cy="80" r="1.5" fill="currentColor" className={`${colors.text} opacity-40`} />
                        {/* 量子连接线 */}
                        <path 
                        ...
                        />
                        {/* 粒子效果 */}
                        <circle cx="120" cy="90" r="0.8" fill="currentColor" className={`${colors.text} opacity-30 animate-pulse`} />
                        <circle cx="200" cy="110" r="0.8" fill="currentColor" className={`${colors.text} opacity-30 animate-pulse`} style={{animationDelay: '0.5s'}} />
                        <circle cx="110" cy="140" r="0.8" fill="currentColor" className={`${colors.text} opacity-30 animate-pulse`} style={{animationDelay: '1s'}} />
                        <circle cx="210" cy="160" r="0.8" fill="currentColor" className={`${colors.text} opacity-30 animate-pulse`} style={{animationDelay: '1.5s'}} />
                      </svg>
                    </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="text-center">
                          ...
                          <div className="text-gray-400 text-xs">{t('ecosystem.ui.active_users')}</div>
                        </div>
                        <div className="text-center">
                          <div className={`text-base font-bold ${colors.text}`}>{app.features}</div>
                          <div className="text-gray-400 text-xs">{t('ecosystem.ui.core_features')}</div>
                        </div>
                      </div>
                  ...
                  {/* 连接点 */}
                  <div className={`absolute top-1/2 ${isLeft ? '-right-4' : '-left-4'} w-8 h-8 bg-gradient-to-r ${colors.bg} rounded-full border-2 ${colors.border} transform -translate-y-1/2 flex items-center justify-center`}>
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    {/* 应用介绍 */}
                    <div className="mb-8">
                      <h3 className="text-lg font-semibold text-white mb-3">{t('ecosystem.modal.introduction')}</h3>
                      <p className="text-gray-300 leading-relaxed">{details.introduction}</p>
                    </div>

                    {/* 核心功能 */}
                    <div className="mb-8">
                      <h3 className="text-lg font-semibold text-white mb-3">{t('ecosystem.modal.core_features')}</h3>
                    ...
                    {/* 技术规格 */}
                    <div className="mb-8">
                      <h3 className="text-lg font-semibold text-white mb-3">{t('ecosystem.modal.tech_specs')}</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    {/* 使用统计 */}
                    <div className="mb-8">
                      <h3 className="text-lg font-semibold text-white mb-3">{t('ecosystem.modal.usage_stats')}</h3>
